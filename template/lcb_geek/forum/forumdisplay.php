...
<!--{template common/headerforumdisplay}-->
...
<div class="boardnav">
	<div id="ct" class="wp cl ct2"{if $_G['forum']['allowside']} ct2{/if}"{if $leftside} style="margin-left:{$_G['leftsidewidth_mwidth']}px"{/if}>
		<!--{if $leftside}-->
		...
		<div class="sd cl"><!--[diy=diy5]--><div id="diy5" class="area"></div><!--[/diy]--></div>
